...
private:
    ...
    enum class ResultType { NOTHING, IDLIST, NAMELIST, TYPELIST, COORDLIST, ROUTE, WAYS  };
    ...
    using CmdResult = std::pair<ResultType, std::variant<CmdResultIDs, CmdResultNames, CmdResultPlaceTypes, CmdResultCoords, CmdResultRoute>>;
    ...
    CmdResult cmd_get_ways_from(std::ostream& output, MatchIter begin, MatchIter end);
    CmdResult cmd_get_way_coords(std::ostream& output, MatchIter begin, MatchIter end);
    ...
    bool test_get_ways_from(Stopwatch& stopwatch, std::ostream& output);
    bool test_get_way_coords(Stopwatch& stopwatch, std::ostream& output);
    bool test_remove_way(Stopwatch& stopwatch, std::ostream& output);
    bool test_route_any(Stopwatch& stopwatch, std::ostream& output);
    bool test_route_least_crossroads(Stopwatch& stopwatch, std::ostream& output);
    bool test_route_shortest_distance(Stopwatch& stopwatch, std::ostream& output);
    bool test_route_with_cycle(Stopwatch& stopwatch, std::ostream& output);
    bool test_trim_ways(Stopwatch& stopwatch, std::ostream& output);
    ...
    void add_random_ways(Stopwatch & stopwatch, unsigned int n);
